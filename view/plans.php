...
<html lang="en">
    ...
    <div class="">
                ...
                <div class="collapse navbar-collapse ml-2" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav mr-5">
                    <li class="nav-item mr-3"> 
                        <a class="nav-link sign-in" data-toggle="modal" data-target="#signinModal">Sign in</a>
                    </li>
                    <li class="nav-item sign-up">
                        <a class="btn btn-greenn plan-signup my-sm-0 mr-5" data-toggle="modal" data-target="#signupModal">Sign up</a>
                    </li>
                  </ul>
                </div>
            </nav>
        ...
        <div class="text-center">
            <div class="container mt-4 pt-4">
                <div class="container h-100">
                    <div class="col-lg-12 my-auto px-5">
                        <div class="mx-auto about">
                            <h1 class="mb-2" style="font-size: 38px; color: #525252;">Laundry Plans</h1>
                            <p class="mb-4 pb-0 laund">Simple plans for everyone! 20 to 25 pounds of laundry each week </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-center align-items-center mt-4 mb-5 pb-5">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <div class="ml-5 about">
                        <div class="card" style="width: 18rem;">
                            <div class="card-header">
                                <h5 class=" mt-4" style="font-weight:700 ; font-size: 32px;">&#8373;25.00 <br> <span style="font-weight:600 ; font-size: 16px;">per month</span></h5>
                                <!-- <p>per month</p> -->
                            </div>
                            <div class="card-body mt-3">
                                <ul class=" list-unstyled" style="font-size: 16px; font-weight: 400;">
                ...
                <div class="col-md-4 my-5">
                    <div class="ml-5 about">
                        <div class="card" style="width: 18rem;">
                            <div class="card-header">
                                <h5 class=" mt-4" style="font-weight:700 ; font-size: 32px;">&#8373;30.00 <br> <span style="font-weight:600 ; font-size: 16px;">One time package</span></h5>
                                <!-- <p>per month</p> -->
                            </div>
                            <div class="card-body mt-3">
                                <ul class=" list-unstyled" style="font-size: 16px; font-weight: 400;">
        ...
        <!-- Sign in Modal -->
        <div class="modal fade bd-example-modal-lg" id="signinModal" tabindex="-1" role="dialog" aria-labelledby="signinModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class=" d-none d-md-flex col-lg-5 bg-image3"></div>
        ...
        <!-- Signup Modal -->
        <div class="modal fade bd-example-modal-lg" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="signinModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
